...
These skills are built for tasks where the agent needs local operating context: reading and organizing Apple Mail, or delegating work to the local Claude Code CLI.
...
Mail.app has account-specific mailbox names, Gmail archive behavior is label-based, and UI state can lag behind the local index. Claude Code delegation also needs a clear responsibility split: Claude can do the work, while Codex decides how to review and finish.
